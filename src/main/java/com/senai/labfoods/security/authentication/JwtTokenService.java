...
public class JwtTokenService {
  private static final String SECRET_KEY = "UkliYqG,r,6S:MR0y?,jWd8HDQ]lof";

  private static final String ISSUER = "labfoods";
  ...
  public String getSubjectFromToken(String token) {
    try {
      ...
      throw new AuthorizationFailedException("Token inválido ou expirado.");
    }
  }
